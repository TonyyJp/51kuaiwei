  ...
  <!-- 内容 START -->
    ...
    <script>
        ...
        <div class="right-content fRight">
           <h2>
            <?php switch($publish_type_status): case "1": ?>已发布的微信群<?php break;?>
              <?php case "2": ?>已发布的个人微信<?php break;?>
              <?php case "3": ?>已发布的公众号<?php break;?>
              <?php case "4": ?>已发布的货源<?php break; endswitch;?>
           </h2>
              ...
              <table align="center" border="1" bordercolor="#e3e7ea" width="90%">
                <tbody>
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      <td align="center" height="40" valign="middle"><?php echo ($vo["id"]); ?></td>
                      <td align="center" height="40" valign="middle">
                        <?php if($vo["status"] == 1): ?><a href="<?php echo U('Weixin/show',array('id'=>$vo['id']));?>" target='_blank'><?php echo ($vo["title"]); ?></a>
                          <?php else: ?>
                          <?php echo ($vo["title"]); endif; ?>                      </td>
                      <td align="center" height="40" valign="middle"><?php echo (getcategoryname($vo["catid"])); ?></td>
                      <td align="center" height="40" valign="middle">
                        <?php if($vo["status"] == 1): ?>已审核
                          ...
                          <?php else: ?>
                          未通过<?php endif; ?>                      </td>
                      <td align="center" height="40" valign="middle"><?php echo (todate($vo["create_time"],'Y-m-d H:i')); ?></td>
                      <td align="center" height="40" valign="middle">
                        <a href="<?php echo U('Member/edit',array('id'=>$vo['id']));?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="foreverdel(<?php echo U('Member/delete',array('id'=>$vo['id']));?>);">删除</a>                      </td>
