    ...
    <script>
      ...
      <div class="right-content fRight">
        ...
        <div class="mainbody mt10">
          <form method='post' id="formInformation" name="formInformation" action="<?php echo U('Member/changeAvatar');?>" enctype="multipart/form-data">
            <div class="d1">
                <label>我的头像：</label>
                <div>
                  <?php if(!empty($udata["thumb"])): ?><input type="hidden" value="__ROOT__/Uploads/<?php echo ($udata["thumb"]); ?>" name="thumb" id="thumb">
                  <img id="thumbsrc" src="__ROOT__/Uploads/<?php echo ($udata["thumb"]); ?>" height="160" width="160">
                  <?php else: ?>
				  <input type="hidden" value="" name="thumb" id="thumb">
                  <img id="thumbsrc" src="/404/avatar.jpg"><?php endif; ?>
                </div>
            </div>
            <div class="d1">
