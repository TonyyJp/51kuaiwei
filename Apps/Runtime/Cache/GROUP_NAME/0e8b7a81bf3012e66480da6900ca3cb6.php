      ...
      <div class="c-top">
        <p>我的位置：<a href="/">首页</a> &gt; 
          <?php if(is_array($position)): $i = 0; $__LIST__ = $position;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo['id']) == "87"): ?><a href="<?php echo U('Weixin/area',array('id'=>$vo['id']));?>"><?php echo ($vo["catname"]); ?></a>&nbsp;&gt;
            ...
            <?php else: ?> <a href="<?php echo U('Weixin/index',array('id'=>$vo['id']));?>"><?php echo ($vo["catname"]); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
        </p>
      </div>
      <div class="c-left fLeft">
        <ul class="article">
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
              <span class="fLeft">
                <a href="<?php echo U('Article/show',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a>
              </span>
              <span class="fRight"><?php echo (date('Y-m-d H:i',$vo["create_time"])); ?></span>
            </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
