        ...
        <div class="right-content fRight">
            ...
            <div class="mainbody mt10">
                <div class="operate">
                        ...
                        <form method="post" action="<?php echo U('Member/paylist',array('catid'=>$catid));?>">
                ...
                <div class="list paylist">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["payno"]); ?></td>
                            <td><?php echo (todate($vo["create_time"],"Y-m-d H:i:s")); ?></td>
                            <td><?php echo ($vo["paytypename"]); ?></td>
                            <td><?php echo (round($vo["paymoney"],2)); if(($vo["type"]) == "1"): ?>元<?php else: ?>点<?php endif; ?></td>
                            <td>
                                <?php if($vo['status'] == 1): ?>交易成功
                            ...
                            <td align="center">
                                <?php if($vo['status'] == 3): echo ($vo["pay_btn"]); endif; ?>
                            </td>
