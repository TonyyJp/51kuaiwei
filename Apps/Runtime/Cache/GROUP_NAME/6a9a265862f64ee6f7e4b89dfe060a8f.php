...
<script>var ajaxurl="<?php echo U('Ajax/getArea');?>"; var city="<?php echo ($udata["city"]); ?>"</script>
    ...
    <script>
      ...
      <div class="right-content fRight">
        ...
        <div class="mainbody mt10">
          <form method='post' id="formInformation" name="formInformation" action="<?php echo U('Member/checkInformation');?>" enctype="multipart/form-data">
            <div class="d1">
              <label for="name">昵称：</label>
              <input name="nickname" id="nickname" class="i1" value="<?php echo ($udata["nickname"]); ?>" type="text">
            </div>
            <div class="d1">
              <label for="wxh">个人微信号：</label>
              <input name="wxaccount" id="wxaccount" class="i1" type="text" value="<?php echo ($udata["wxaccount"]); ?>">
            </div>
            <div class="d1">
              <label>性别：</label>
              <input name="gender" value="1" type="radio" <?php if(($udata["gender"]) == "1"): ?>checked<?php endif; ?>>男
              <input name="gender" value="2" type="radio" <?php if(($udata["gender"]) == "2"): ?>checked<?php endif; ?>>女</div>
            <div class="d1">
              <label>生日:</label>
              ...
              <script>
                var year = "<?php echo ($udata["year"]); ?>";
                var month = "<?php echo ($udata["month"]); ?>";
                var day = "<?php echo ($udata["day"]); ?>";
  ...
  <!-- 内容 END -->
   <script type="text/javascript">
    ...
    $(function(){
        ...
        //选择省份
        $("#province option[value='<?php echo ($udata["province"]); ?>']").attr("selected", true); 
    ...
    function foreverdelthumb(cur,img){
       ...
       var url="<?php echo U('Member/delfile');?>";
