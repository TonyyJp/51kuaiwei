    ...
    <script>
        ...
        <div class="right-content fRight">
            ...
            <div class="mainbody mt10">
                <div class="operate">
            <div class="fLeft">
                <input type="button" onclick="add()" class="submit btn5" value="添加促销">
            </div>
            <div class="fLeft">
                <form method="post" action="<?php echo U('Member/promotionlist',array('catid'=>131));?>">
                    <input type="text" name="name" title="促销标题" class="ipt5">
                    <select name="zt">
                      <option value="-2" 
                      <?php if(($zt) == "-2"): ?>selected="selected"<?php endif; ?>
                      >全部
                      </option>
                      <option value="2" 
                      <?php if(($zt) == "2"): ?>selected="selected"<?php endif; ?>
                      ...
                      <option value="1" 
                      <?php if(($zt) == "1"): ?>selected="selected"<?php endif; ?>
                      >已审核
                      </option>
                      <option value="0" 
                      <?php if(($zt) == "0"): ?>selected="selected"<?php endif; ?>
                      >未通过
                      </option>
                    </select>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><a href="<?php echo U('Weixin/show',array('id'=>$vo['pubaccountid']));?>" target='_blank'><?php echo (getweixinname($vo["pubaccountid"])); ?></a></td>
                      <td><a href="<?php echo U('Promotion/show',array('id'=>$vo['id']));?>" target='_blank'><?php echo ($vo["title"]); ?></a></td>
                      <td><?php echo (todate($vo["create_time"],'Y-m-d')); ?></td>
                      <td><?php echo ($vo["intergral"]); ?></td>
                      <td><?php if($vo["status"] == 2): ?>待审核
                          <?php elseif($vo["status"] == 1): ?>
                          已审核
                          <?php elseif($vo["status"] == 0): ?>
                          未通过<?php endif; ?></td>
                      <td><a href="<?php echo U('Member/promotionedit',array('id'=>$vo['id']));?>">修改</a></td>
...
<script type="text/javascript">
    function add(){
        location.href="<?php echo U('Member/promotionadd',array('catid'=>131));?>";
    }
